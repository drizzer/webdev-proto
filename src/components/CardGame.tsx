...
import { Heading, Card, CardHeader, CardBody, CardFooter, Button, Box, Skeleton, Text, Stack, Image } from '@chakra-ui/react';
...
export function CardGame({ isLoaded }: CardGameProps) {
    return (
        <Skeleton
            isLoaded={isLoaded}
            bg="green.500"
